...
<div class="container">
    ...
    <ul class="nav nav-tabs">
        <li class="active"><a href="#tab" data-toggle="tab">一覧</a>
        </li>
        <li><a href="#tab1" data-toggle="tab">食べる</a>
        </li>
...
<?php } ?>
  ...
  <div class="tab-pane fade in active" id="tab1">
    ...
    while($num_of_spots > $count){
        ?>
       <?php if($spots[$count]['Spot']['category_id'] == 1){ ?>
	    <li class="list-group-item">
            <a href="play?spot_id=<?php echo $spots[$count]['Spot']['id'] ?>&lat=<?php echo $lat ?>&lng=<?php echo $lng?>">
                <?php echo $spots[$count]['Spot']['name'] ?>
            </a>
  ...
  <div class="tab-pane fade in active" id="tab2">
    ...
    while($num_of_spots > $count){
        ?>
       <?php if($spots[$count]['Spot']['category_id'] == 2){ ?>
	    <li class="list-group-item">
            <a href="play?spot_id=<?php echo $spots[$count]['Spot']['id'] ?>&lat=<?php echo $lat ?>&lng=<?php echo $lng?>">
                <?php echo $spots[$count]['Spot']['name'] ?>
            </a>
  ...
  <div class="tab-pane fade in active" id="tab3">
    ...
    while($num_of_spots > $count){
        ?>
       <?php if($spots[$count]['Spot']['category_id'] == 3){ ?>
	    <li class="list-group-item">
            <a href="play?spot_id=<?php echo $spots[$count]['Spot']['id'] ?>&lat=<?php echo $lat ?>&lng=<?php echo $lng?>">
                <?php echo $spots[$count]['Spot']['name'] ?>
            </a>
  ...
  <div class="tab-pane fade in active" id="tab4">
    ...
    while($num_of_spots > $count){
        ?>
       <?php if($spots[$count]['Spot']['category_id'] == 4){ ?>
	    <li class="list-group-item">
            <a href="play?spot_id=<?php echo $spots[$count]['Spot']['id'] ?>&lat=<?php echo $lat ?>&lng=<?php echo $lng?>">
                <?php echo $spots[$count]['Spot']['name'] ?>
            </a>
  ...
  <div class="tab-pane fade in active" id="tab5">
    ...
    while($num_of_spots > $count){
        ?>
       <?php if($spots[$count]['Spot']['category_id'] == 5){ ?>
	    <li class="list-group-item">
            <a href="play?spot_id=<?php echo $spots[$count]['Spot']['id'] ?>&lat=<?php echo $lat ?>&lng=<?php echo $lng?>">
                <?php echo $spots[$count]['Spot']['name'] ?>
            </a>
